...
3. Click **Submit**, paste: `https://github.com/Multek-Company/laravel-customer-engagement`
...
Check [packagist.org/packages/multek/laravel-customer-engagement](https://packagist.org/packages/multek/laravel-customer-engagement) — the new version should appear instantly (webhook is configured).
...
# Specific version
composer require multek/laravel-customer-engagement:^1.0

# Update to latest
composer update multek/laravel-customer-engagement
```
